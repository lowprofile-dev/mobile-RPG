        ...
        if (CanCollision(other))
        {
            ...
            else
            {
                ...
                {   
                    ...
                    other.GetComponent<LivingEntity>().Damaged((_useMeleeDmg ? StatusManager.Instance.finalStatus.attackDamage : StatusManager.Instance.finalStatus.magicDamage) * _damage);
                }
